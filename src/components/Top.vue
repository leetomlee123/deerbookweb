<template>
    <div>
      ...
      <h3 class="rank-head"><span>男生榜</span></h3>
        <div class="row">
            <div class="rank-list col-12 col-md-3" v-for="(key,idx) in words" :key="key">
                    ...
                    <div class="book-list">
                        <ul>
                            <li v-for="(k,i) in values[idx]" :key="k+i">
                                <div class="num-box"><span v-bind:class="colors[i>3?3:i]">{{i+1}}</span>
                                </div>
                                <div class="name-box"><a v-on:click="goto(k.id)">{{k.name}}</a></div>
                            </li>
                        </ul>
                    </div>
                </i>
        ...
        <div class="row">
            <div class="rank-list col-12 col-md-3" v-for="(key,idx) in gwords" :key="key">
                <h3 class="wrap-title lang">
                    {{key}}
                </h3>
                <i>
